...
import { verifyRazorpayPayment } from "@/services/checkoutService";
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {order.paymentMethod === "razorpay" &&
        ...
        order.finalAmount - order.paidAmount > 0 && (
          <Button onClick={handleRemainingPayment} className="bg-amber-600 hover:bg-amber-700 w-full md:w-auto">
